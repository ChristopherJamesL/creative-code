          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            {user && (
              <div className="relative group/logout">
                ...
                <span className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 rounded bg-foreground px-1.5 py-0.5 text-[11px] text-background whitespace-nowrap opacity-0 group-hover/logout:opacity-100 transition-opacity">
                  Sign out
                </span>
              </div>
            )}
